...
function plugin(opts){
  ...
  return function(files, metalsmith, done){
    ...
    function convert(file, done){
      ...
      var clone = extend({}, clonedParams);

      // #MegaJ This is my modification. I want my data namespaced. This makes it easier to scope things
      // Useful when using nunjucks macros...
      clone.file = data;
